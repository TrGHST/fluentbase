...
use crate::{header_item_size, WritableBuffer};

// #[derive(Debug, Clone, Copy, Default, PartialEq)]
// pub struct EmptyVec;
//
// impl<E: ByteOrder, const A: usize, ENCODER: Encoder<E, A, EmptyVec>> Encoder<E, A, EmptyVec>
//     for EmptyVec
// {
...
//
//     fn decode_header(
//         decoder: &mut BufferDecoder<E, A, Self, ENCODER>,
//         field_offset: usize,
