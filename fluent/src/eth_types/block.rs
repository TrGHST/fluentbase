...
pub struct Block {
    pub header: Header,
    pub transactions: Vec<new_tx::Transaction>,
...
impl Block {
    ...
    pub fn transactions_root(&self) -> H256 {
        ...
        for (index, tx) in self.transactions.iter().enumerate() {
            ...
            // TODO ! error handling !
            trie.insert(&path, &encoded_tx).unwrap();
        }
        // TODO ! error handling !
    ...
    pub fn uncles_root(&self) -> H256 {
        ...
        // hash rlp uncles
        let hash = keccak_hash::keccak(&uncles_rlp);
        hash
    }
}
...
mod tests {
    ...
    fn block_body_validates_transactions_root() {
        ...
        println!("{:?}", block_body.transactions_root());
        return;
    ...
    fn get_14764013_block_body() -> Block {
