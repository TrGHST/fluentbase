use super::bytes::hex_decode;
use bytes::Bytes;
use eth_trie::{EthTrie, MemoryDB, Trie};
use ethereum_types::{Address, Bloom, BloomInput, H256, U256};
use rlp::{self, Decodable, DecoderError, Encodable, Rlp, RlpDecodable, RlpEncodable, RlpStream};
...
impl Receipts {
    pub(crate) fn root(&self) -> H256 {
        ...
        for (index, receipt) in self.receipt_list.iter().enumerate() {
            ...
            // TODO ! error handling !
            trie.insert(&path, &encoded_receipt).unwrap();
        }
        // TODO ! error handling !
...
mod tests {
    ...
    fn calculate_receipts_root() {
        ...
        println!("EXPECTED: {:?}", EXPECTED_RECEIPTS_ROOT);
        receipts.root();
        assert_ne!(1, 1);
        // assert_eq!(
    ...
    const RECEIPT_0: &str = "";
    const RECEIPT_1: &str = "";
    const RECEIPT_2: &str = "";
